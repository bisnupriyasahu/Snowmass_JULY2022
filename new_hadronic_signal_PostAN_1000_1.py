...
for entry in range(0, numberOfEntries):
  ...
  for igen,gen in enumerate(branchParticle):
    ...
    for jgen,genlep in enumerate(branchParticle):
      ...
      if(dr_1 < 0.3):
        ...
        #print("gen1_index in gen loop ", gen1_idx)
        #count_10 += 1
        #nEntries_10.Fill(1)
    ...
    print("gen1_index in gen loop ", gen1_idx)
    print("gen2_index in gen loop ", gen2_idx)
  ...
  print("gen1_index outside gen loop ", gen1_idx)
  print("gen2_index outside gen loop ", gen2_idx)
      
  if(gen_1 is not None):
    print("gen1_index ", gen1_idx)
    gen_1PT = gen_1.PT
    count_3 += 1
    #nEntries_3.Fill(1)
