{
  ...
  TH1F *h1 = dynamic_cast<TH1F*>(datafile1->Get("HT"));
  TH1F *h2 = dynamic_cast<TH1F*>(datafile2->Get("HT"));
  //TH1F *h3 = dynamic_cast<TH1F*>(datafile3->Get("HT"));
  //TH1F *h4 = dynamic_cast<TH1F*>(datafile4->Get("HT"));

  
  // TH1F *h5 = dynamic_cast<TH1F*>(datafile5->Get("HT"));
  //TH1F *h6 = dynamic_cast<TH1F*>(datafile6->Get("HT"));
  TH1F *h7 = dynamic_cast<TH1F*>(datafile7->Get("HT"));
  TH1F *h8 = dynamic_cast<TH1F*>(datafile8->Get("HT"));

  TH1F *h9 = dynamic_cast<TH1F*>(datafile9->Get("HT"));
  TH1F *h10 = dynamic_cast<TH1F*>(datafile10->Get("HT"));
...
std::cout<<"-------------------------------------------------------------------"<<std::endl;
  ...
  //h6->Draw("HIST");  
  //
  stackHisto->SetTitle("HT - Hadronically decayed #tau");  
  ...
  stackHisto->GetXaxis()->SetTitle("HT");
