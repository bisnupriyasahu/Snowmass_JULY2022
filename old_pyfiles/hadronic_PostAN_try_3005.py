...
for entry in range(0, numberOfEntries):
  ...
  for igen,gen in enumerate(branchParticle):
    ...
    if(abs(gen.PID) == 15):
      ...
      if (dr_1 < 0.3):
        gen_t1 = igen
        print("dr gen tau1 ", dr_1)
        if (dr_1 < min_dr):
          min_dr = dr_1
          DR_nr_genreco1.Fill(min_dr)
      elif (dr_2 < 0.3):
        gen_t2 = igen
        print("dr gen tau2 ", dr_2)
        if(dr_1 < min_dr):
          min_dr = dr_2  
          DR_nr_genreco2.Fill(min_dr)


  gen_1 = branchParticle.At(gen_t1)
  gen_2 = branchParticle.At(gen_t2)
  if (gen_1 is not None):
    print ("gen_1.PT: ",gen_1.PT)
    gen_1pt = gen_1.PT/tau1.PT
    gen1_p4.SetPtEtaPhiM(gen_1.PT, gen_1.Eta, gen_1.Phi, gen_1.Mass)     
    if (gen_1.PT > 30  and gen_1.PT < 50):
      t1_R_3050.Fill(leadchtau1)

    elif (gen_1.PT > 50 and gen_1.PT < 80):
      t1_R_5080.Fill(leadchtau1)

    elif (gen_1.PT > 80 and gen_1.PT < 130):
      t1_R_80130.Fill(leadchtau1)

    elif (gen_1.PT > 130 and gen_1.PT < 180):
      t1_R_130180.Fill(leadchtau1)

    elif (gen_1.PT > 180 and gen_1.PT < 230):
      t1_R_180230.Fill(leadchtau1)

    elif (gen_1.PT > 230 and gen_1.PT < 280):
      t1_R_230280.Fill(leadchtau1)

    elif (gen_1.PT > 280 and gen_1.PT < 330):
      t1_R_280330.Fill(leadchtau1)

    elif (gen_1.PT > 330 and gen_1.PT < 380):
      t1_R_330380.Fill(leadchtau1)

    elif (gen_1.PT > 380 and gen_1.PT < 500):
  ...
  if (gen_2 is not None):
    ...
    if (gen_2.PT > 30  and gen_2.PT < 50):
      t2_R_3050.Fill(leadchtau2)

    elif (gen_2.PT > 50 and gen_2.PT < 80):
      t2_R_5080.Fill(leadchtau2)

    elif (gen_2.PT > 80 and gen_2.PT < 130):
      t2_R_80130.Fill(leadchtau2)

    elif (gen_2.PT > 130 and gen_2.PT < 180):
      t2_R_130180.Fill(leadchtau2)

    elif (gen_2.PT > 180 and gen_2.PT < 230):
      t2_R_180230.Fill(leadchtau2)

    elif (gen_2.PT > 230 and gen_2.PT < 280):
      t2_R_230280.Fill(leadchtau2)

    elif (gen_2.PT > 280 and gen_2.PT < 330):
      t2_R_280330.Fill(leadchtau2)

    elif (gen_2.PT > 330 and gen_2.PT < 380):
      t2_R_330380.Fill(leadchtau2)

    elif (gen_2.PT > 380 and gen_2.PT < 500):
