...
<<<<<<< HEAD
    ...
    if(abs(gen.PID) == 1000006 and (gen.Mass == 300 or gen.Mass == 301 or gen.Mass == 299 )):
      STOP_idx_300 = igen
      print("STOPMASS 300: ",gen.Mass )
    if(abs(gen.PID) == 1000006 and (gen.Mass == 500or gen.Mass == 501 or gen.Mass == 499 )):
      STOP_idx_500 = igen
      print("STOPMASS 500: ",gen.Mass )
    if(abs(gen.PID) == 1000006 and (gen.Mass == 1000 or gen.Mass == 1001 or gen.Mass == 999 )):
      STOP_idx_1000 = igen
      print("STOPMASS 1000: ",gen.Mass )
    if(abs(gen.PID) == 1000022 and ( gen.Mass == 1 or gen.Mass == 2)):
      LSP_idx_1 = igen
      print("LSPmass 1",gen.Mass )
    if(abs(gen.PID) == 1000022 and (gen.Mass == 350 or gen.Mass == 351 or gen.Mass == 349 ) ):
      LSP_idx_350 = igen
      print("LSPmass 350",gen.Mass )
      
      #and gen.Mass == 100 and igen != STOP_idx):   
      #LSP_idx = igen


    if(not (STOP_idx_300 >= 0 and LSP_idx_1 >= 0 and igen != (STOP_idx_300 or LSP_idx_1))): continue
    nEvents_1.Fill(1)
    count_1 += 1
    nEvents_1.Fill(2,count_1)        
    #    dr_match(gen,gen_1,gen_2,gen_1PT,gen_2PT,DR_nr_genreco1,DR_nr_genreco2)
